...
public class Runner {
	...
	public static void main(String[] args){ 
		...
		boolean flag = YandexLoginScreen.open().typeLogin("TestNGtask3").typePassword("Tester123").submitEnter().isLoginSuccess();
		if(flag) {
			YandexMailScreen mail = new YandexMailScreen();
		//	boolean flag2 = mail.clickCompose().typeMailTo("TestNGtask3@yandex.by").typeSubject("test 1").clickSend().isMessageSent();
		...
		CmdLineParser cli = new CmdLineParser(sets);
		try {
